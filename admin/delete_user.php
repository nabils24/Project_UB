...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_GET['uuid'])) {
        ...
        if ($stmt->execute()) {
            ...
            header('Location: listuser.php?success=user_deleted');
        } else {
            // Redirect with an error message
            header('Location: listuser.php?warning=delete_failed');
        }
        ...
        header('Location: listuser.php?warning=invalid_request');
    }
} else {
